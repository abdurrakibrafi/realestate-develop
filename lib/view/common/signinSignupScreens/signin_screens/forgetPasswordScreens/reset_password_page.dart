...
import 'package:real_estate_management/viewModel/controllers/authControllers/reset_password_controller.dart';

class ResetPasswordPage extends StatelessWidget {
  final bool bottomSheet;
  const ResetPasswordPage({super.key, this.bottomSheet = false});
                  ...
                  child: Obx(() {
                    return Column(
                      children: [
                        ...
                        //     suffix: (!controller.oPassVisibility.value)
                        //         ? InkWell(
                        //             onTap: () {
                        ...
                        commonTextfieldWithTitle(
                            "Confirm Password".tr, controller.cPassController,
